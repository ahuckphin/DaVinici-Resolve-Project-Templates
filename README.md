# DaVinici-Resolve-Project-Templates
...
2. colour correction to slightly boost gain, saturation and contrast (5% boost each)

   gain 1.0 to 1.05
   
   saturation 50.0 to 52.5
   
   contrast 1.0 to 1.05
